...
@Mod(modid = ResourceMod.MOD_ID, name = "ResourceMod", version = Constants.version)
public class ResourceMod {
    ...
    public void preInit(FMLPreInitializationEvent e) {/*
        ...
        try {
            ...
            for (String lib : libs) {
                System.out.println(ResourceMod.class.getResource("/com/github/yuitosaito/libs/" + lib));
                addURL.invoke(loader, ResourceMod.class.getResource("/com/github/yuitosaito/libs/" + lib));
            }
            URL[] urls = (URL[]) URLClassLoader.class.getMethod("getURLs").invoke(Launch.classLoader.getClass().getClassLoader());
            System.out.println("-----------");
            for (URL url : urls)
